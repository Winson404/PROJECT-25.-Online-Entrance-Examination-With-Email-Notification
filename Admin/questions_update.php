                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="category_Id" required>
                            ...
                            <?php 
                              $fetch2 = mysqli_query($conn, "SELECT * FROM category");
                              while($row2 = mysqli_fetch_array($fetch2)) {
                            ?>
                            <option value="<?php echo $row2['cat_Id']; ?>" <?php if($row2['cat_Id'] == $cat_Id) { echo 'selected'; } ?>><?php echo $row2['cat_name']; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="col-lg-6"></div>
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                              ...
                              <button type="submit" class="btn bg-gradient-primary float-sm-right" name="update_quest">Submit</button>
                              <a class="btn bg-gradient-secondary float-sm-right" href="questions.php" style="margin-right: 5px;">Back</a>
                          </div>
                        </div>
                     </div>
                    </form>
