  ...
  <footer class="main-footer">
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-6 col-12 bg-white">
        <label>Mission</label>
        <p class="text-sm text-justify text-muted">Lorem, ipsum dolor, sit amet consectetur adipisicing elit. Recusandae delectus voluptate, illum, provident maxime est? Tenetur, eos fugiat vel excepturi. Dolore iure, vitae provident! Quis incidunt cum temporibus accusantium ducimus!</p>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 col-12 bg-white">
        <label>Vision</label>
        <p class="text-sm text-justify text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius ratione illo laborum consequuntur provident deserunt ad odio impedit saepe fugiat voluptatem dolorum amet facere, laudantium beatae nam architecto delectus perferendis!</p>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 col-12 bg-white">
    ...
    <strong>Copyright &copy; 2022 <a href="#">SPS Entrance Exam.</a>.</strong>
    All rights reserved.
