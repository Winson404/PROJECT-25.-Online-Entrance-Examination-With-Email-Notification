<title>SPS Online Entrance Examination | Register</title>
          ...
          <div class="col-lg-10 mt-5">
            <div class="card card-outline card-primary">
              ...
              <div class="card-footer alert-light">
                ...
                <button type="submit" class="float-right btn bg-gradient-primary" name="create_examinee" id="create_admin"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
              </div>
              </form>
