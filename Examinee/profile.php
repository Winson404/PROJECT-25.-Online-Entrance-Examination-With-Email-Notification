<title>SPS Entrance Exam. | Examinee profile</title>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="viewprofile">
                      ...
                      <div class="form-group row">
                        <label for="Email" class="col-sm-2 col-form-label">School last attended</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="Email" placeholder="Email" value="<?php echo $row['school']; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
